    ...
    <section id="hero" className="hero-stage relative min-h-screen overflow-hidden pb-16 pt-32 md:pb-24 md:pt-40">
      ...
      <Container className="relative z-10">
        <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_.85fr]">
          <m.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .65 }}>
          ...
          <m.div initial={{ opacity: 0, scale: .92, rotate: 2 }} animate={{ opacity: 1, scale: 1, rotate: 0 }} transition={{ duration: .7, delay: .12 }} className="relative mx-auto w-full max-w-[480px]">
